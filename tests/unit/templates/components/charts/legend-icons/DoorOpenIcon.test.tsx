...
import { DoorOpenIcon } from "../../../../../../src/templates/components/charts/legend-icons/DoorOpenIcon";
...
describe("DoorOpenIcon", () => {
  ...
  it("should call loadSvgContent with correct path and color", () => {
    ...
    render(<DoorOpenIcon color={TEST_COLOR} x={TEST_X} y={TEST_Y} legendBoxSize={TEST_LEGEND_BOX_SIZE} />);
